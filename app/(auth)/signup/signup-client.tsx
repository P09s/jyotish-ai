...
export default function SignupClient() {
  ...
  return (
    <PageTransition>
      ...
      <div className="landing-page relative signup-wrapper">
        <div className="stars" />
        ...
        <nav className="lp-nav" role="navigation" aria-label="Main navigation">
          ...
          <div className="lp-nav-actions">
            <div style={{
              ...
              <HelpButton page="signup" /> {/* You can change "login" to "signup" on the signup page */}
            </div>
          </div>
        </nav>
              ...
              <MotionDiv initial={{ opacity: 0, x: 8 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.22 }}>
                <form onSubmit={handleSignup}>
                  ...
                  <div style={{ marginBottom: 16 }}>
                    ...
                    <div style={{ position: 'relative' }}>
                      <div style={{ position: 'absolute', left: 14, top: '50%', transform: 'translateY(-50%)', pointerEvents: 'none', display: 'flex' }}>
                        <User size={14} color="var(--text-muted)" strokeWidth={1.5} />
                      </div>
                  ...
                  <div style={{ marginBottom: 16 }}>
                    ...
                    <div style={{ position: 'relative' }}>
                      <div style={{ position: 'absolute', left: 14, top: '50%', transform: 'translateY(-50%)', pointerEvents: 'none', display: 'flex' }}>
                        <MapPin size={14} color="var(--text-muted)" strokeWidth={1.5} />
                      </div>
                      <input type="text" required className="input-field"
